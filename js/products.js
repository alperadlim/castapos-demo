const PRODUCTS = [
  ...
  {id:'bissell-proheat', name:'Bissell ProHeat 2X Revolution Halı ve Koltuk Yıkama Makinesi', code:'SPR-G', brand:'Bissell', category:'Ev Aletleri', collection:'Ev Aletleri', price:3500, buyPrice:null, badge:'Premium', discount:null, premium:true, image:'assets/products/bissell-proheat.svg', summary:'Dönemsel temizlik ihtiyaçları için satın almadan profesyonel kullanım deneyimi.', specs:['Temizlik: Halı ve koltuk temizliği','Kullanım: Dönemsel kullanım','Motor: Yüksek emiş gücü','Tür: Ev tipi kullanım','Model: Pratik kiralama'], periods:[3,6,9]},
  {id:'bissell-spotclean', name:'Bissell SpotClean Pro Halı ve Koltuk Yıkama Makinesi', code:'SPR-H', brand:'Bissell', category:'Ev Aletleri', collection:'Ev Aletleri', price:1900, buyPrice:null, badge:'Leke çıkarma', discount:'-%14', premium:false, image:'assets/products/spotclean.svg', summary:'Lokal halı/koltuk temizliği ve dönemsel ihtiyaçlar için pratik temizlik ürünü.', specs:['Özellik: Leke çıkarma','Temizlik: Koltuk temizliği','Kullanım: Kompakt kullanım','Tür: Ev tipi çözüm','Model: Kiralama modeli'], periods:[3,6,9]},
...
const NAV_CATEGORIES = [
  ...
  {name:'Ev Aletleri', href:'kategori.html?cat=Ev%20Aletleri', groups:[['Alt Kategoriler', [
  ...
  {name:'Elektronik', href:'kategori.html?cat=Elektronik', groups:[['Alt Kategoriler', [
    ...
    {label:'Ev / Ofis Teknolojileri', href:'kategori.html?cat=Elektronik&q=Ofis'},
    {label:'Tümünü Gör', href:'kategori.html?cat=Elektronik', all:true}
  ]]]},
  {name:'Güzellik Teknolojileri', href:'kategori.html?cat=Güzellik%20Teknolojileri', groups:[['Alt Kategoriler', [
  ...
  {name:'Premium', href:'kategori.html?cat=Premium', groups:[['Premium Kategorileri', [
  ...
  {name:'Yaz Sezonu', href:'kategori.html?cat=Yaz%20Sezonu', highlight:true, groups:[['Yaz Sezonu Ürünleri', [
